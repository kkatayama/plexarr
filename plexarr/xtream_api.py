...
class XtreamAPI:
    ...
    def setup(self, iptv):
        """
        Load IPTV Configs and Attach to Object

        Example:
            xtream.starr2 = {
                'api_url': 'https://acelive.xyz/player_api.php',
                'username': 'E6ptp4yDBh',
                'password': 'RTGuDw7Q3k',
                'groups': {'USA | Local', 'USA | Sports'},
                'params': {'username': 'E6ptp4yDBh', 'password': 'RTGuDw7Q3k'},
                'category': {},
                'streams': []
            }
        """
